...
export const categoryTitles: CategoryTitles = {
  ...
  deploiement: {
    ...
    '03': {
      title:
        'Mutation De La Pensée Globale Et La Projection De La Protection - PYO Gallery LA - Los Angeles',
      images: {
  ...
  drawing: {
    ...
    '04': {
      title:
        "Etude Préparatoire Sur La Perception Des Interactions De L'infiniment Grand Et De L'Infiniment Petit",
      images: {
    ...
    '05': {
      title:
        'Etude Préparatoire De La Genèse De Pensée Du MétaHisme - Interaction Des Etats Superposés',
      images: {
